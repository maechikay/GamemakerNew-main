...
ds_list_add(sprite_pool,
    spr_FiveCupsReversed, spr_FiveOfPentacles, spr_NineCupsReversed, spr_NineSwords, spr_NineWandsReversed,
	spr_TemperanceReversed, spr_TheDevil, spr_TheMoonReversed, spr_TheStarReversed, spr_TheTower
);
