...
if (dialogue_stage == 0 && !global.dialogue_visible) {
    ...
    current_dialogue = "When I step into the kitchen, both of my parents are there again, sitting at the table with untouched coffee cups.";
