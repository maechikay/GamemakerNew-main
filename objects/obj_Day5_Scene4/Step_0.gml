...
if (dialogue_stage == 0 && !global.dialogue_visible) {
    ...
    current_dialogue = "The professor hands out the test papers.";
    ...
    current_dialogue = "Deep breaths, everyone. Take your time.";
